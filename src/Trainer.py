...
class Trainer(QtGui.QMainWindow):
    ...
    def __init__(self):
        ...
        self.slider_confidence_diff.setMaximum(90)
        self.slider_confidence_diff.setValue(80)
        ...
        self.confidence_val_diff.setText("Difference is 0.8")
        ...
        self.setWindowTitle('Trainer, v0.1.2.5_20171104')
