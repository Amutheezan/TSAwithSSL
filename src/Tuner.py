...
class Tuner(QtGui.QMainWindow):
    ...
    def __init__(self):
        ...
        self.label_ttsa = QtGui.QLabel(self)
        self.label_ttsa.setText("Select the Tune Data Set")
        self.label_ttsa.move(60, 90)
        self.label_ttsa.resize(240, 30)
        self.tune_type_selector = QtGui.QComboBox(self)
        self.tune_type_selector.insertItems(1, self.cons.TUNE_TYPES)
        self.tune_type_selector.move(60, 120)
        self.tune_type_selector.resize(240, 30)
        self.tune_type_selector.setStyleSheet("background-color: white")
        self.label_llt = QtGui.QLabel(self)
        self.label_llt.setText("Label Limit")
        self.label_llt.move(60, 160)
        self.label_limit_text = QtGui.QLineEdit(self)
        self.label_limit_text.move(60, 200)
        ...
        self.setGeometry(560, 300, 360, 290)
