...
class Visualizer(QtGui.QMainWindow):
    def _get_configuration_(self):
        ...
        if train_type == self.cons.TOPIC_BASED_TRAINING_TYPE:
            self.method = TopicOriented(label , un_label , test , iteration, test_type, confidence, confidence_diff)
        elif train_type == self.cons.SELF_TRAINING_TYPE:
            self.method = SelfTraining(label , un_label , test , iteration, test_type, confidence, confidence_diff)
        elif train_type == self.cons.CO_TRAINING_TYPE:
            self.method = CoTraining(label , un_label , test , iteration, test_type, confidence, confidence_diff)
    ...
    def __init__(self):
        ...
        self.slider_confidence.move(210 , 190)
        ...
        self.slider_confidence_diff.move(210 , 240)
        ...
        self.confidence_diff.move(60 , 240)
        ...
        self.confidence_val_diff.move(440 , 240)
        ...
        self.generate_model.move(225 , 290)
        ...
        self.predict_tweet.move(225 , 410)
        ...
        self.prediction.move(30 , 460)
        self.prediction.resize(180, 30)
        self.setGeometry(375 , 120  , 620  , 500)
        self.setWindowTitle('TSAwithSSL, v0.1.2.5')
