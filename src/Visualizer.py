...
class Visualizer(QtGui.QMainWindow):
    ...
    def __init__(self):
        ...
        self.training_type_selector.insertItems(2,self.cons.TRAINING_TYPES)
        ...
        self.train_type_selector.insertItems(2,self.cons.TRAIN_TYPES)
        ...
        self.label_tts = QtGui.QLabel(self)
        self.label_tts.setText("Select the Test Data Set")
        self.label_tts.move(60 , 100)
        self.label_tts.resize(200, 30)
        self.test_type_selector = QtGui.QComboBox(self)
        self.test_type_selector.insertItems(3,self.cons.TEST_TYPES)
        ...
        self.test_limit.setText(str(13000))
        ...
        self.setWindowTitle('TSAwithSSL, v0.1.2.5_10')
